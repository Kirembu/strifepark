...
##SOCIAL_AUTH_USER_MODEL            = 'zerxis.models.CustomUser'
...
SOCIAL_AUTH_LOGIN_REDIRECT_URL = '/zerxis/'
#SOCIAL_AUTH_NEW_USER_REDIRECT_URL = 'zerxis_home'
#SOCIAL_AUTH_NEW_ASSOCIATION_REDIRECT_URL = 'zerxis_home'
#SOCIAL_AUTH_DISCONNECT_REDIRECT_URL = 'zerxis_home'
#SOCIAL_AUTH_BACKEND_ERROR_URL = 'zerxis_home'
#SOCIAL_AUTH_COMPLETE_URL_NAME  = 'zerxis_home'
#SOCIAL_AUTH_ASSOCIATE_URL_NAME = 'zerxis_home'
SOCIAL_AUTH_DEFAULT_USERNAME = lambda: random.choice(['kibaki', 'kinyanjui', 'moi', 'mitchel', 'kenyatta', 'ronald_ngala', 'carey_francis', 'tom_mboya', 'mumia', 'james'])
...
SOCIAL_AUTH_PIPELINE = (
    ...
    'zerxis.pipeline.redirect_to_form',
    'zerxis.pipeline.username',
